 ...
 */
final class Version20220623083150 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE burger CHANGE catalogue_id catalogue_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE burger CHANGE catalogue_id catalogue_id INT DEFAULT NULL');
