...
/**
 * @extends ServiceEntityRepository<MenuCommande>
 *
...
class MenuCommandeRepository extends ServiceEntityRepository
{
    ...
    public function add(MenuCommande $entity, bool $flush = false): void
    {
    ...
    public function remove(MenuCommande $entity, bool $flush = false): void
    {
